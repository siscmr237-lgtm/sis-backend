...
const { computeSchoolAbbreviation } = require('../src/utils/schoolAbbreviation');
...
async function forceVerifySignup(email, reason) {
  ...
  await prisma.school.create({
    data: {
      ...
      // Must match what POST /auth/signup sets — abbreviation is NOT NULL with
      // no column default, so omitting it here made this command throw outright
      // rather than create the account.
      abbreviation: computeSchoolAbbreviation(pending.schoolName),
